...
constant, an `MV` object, or an `MVRef` object, or specified in terms
...
an `MV` constant, an `MV` object, or an `MVRef` object, or specified in
terms of its horizontal and vertical components.
...
`MV` constant, an `MV` object, or an `MVRef` object, or specified in
terms of its horizontal and vertical components.
